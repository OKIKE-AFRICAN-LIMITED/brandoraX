      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl border border-brand-gray-200 relative overflow-hidden">
        ...
        {!completed ? (
          ...
          <div className="text-center py-4">
            ...
            <span className="text-xs font-mono font-bold uppercase tracking-wider text-brand-blue bg-brand-blue-light px-3 py-1 rounded-full">
            ...
            <div className="bg-brand-gray-50 border border-brand-gray-200 rounded-xl p-5 text-left mb-8 max-w-lg mx-auto">
              <div className="flex items-center justify-between text-xs font-mono text-brand-gray-500 mb-2">
                <span>Discipline: <strong className="text-brand-navy">{recommendedTrack?.category}</strong></span>
                <span>Duration: <strong className="text-brand-navy">{recommendedTrack?.duration}</strong></span>
              </div>
              <div className="text-xs font-mono text-brand-blue font-semibold mb-3">
                Tuition: {recommendedTrack?.tuition.upfront}
              </div>
              <div className="text-[11px] font-mono uppercase text-brand-gray-500 mb-1 font-semibold">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <button
                onClick={handleReset}
                className="text-xs font-mono text-brand-gray-500 hover:text-brand-navy inline-flex items-center gap-1 py-2 px-3"
              >
