...
export const ProgramsSection: React.FC<ProgramsSectionProps> = ({
  ...
  return (
    <section id="programs" className="py-24 px-4 sm:px-6 bg-brand-gray-100 border-b border-brand-gray-200 scroll-mt-20 w-full max-w-full overflow-hidden">
      <div className="max-w-7xl mx-auto">
            ...
            >
              <div>
                ...
                <div className="p-6 pb-4 border-b border-brand-gray-200/60 bg-gradient-to-r from-brand-gray-50 to-white flex items-center justify-between">
                  ...
                  <span className="text-xs text-brand-gray-500 flex items-center gap-1 font-medium">
                ...
                <div className="p-6">
                  ...
                  <div className="bg-brand-gray-50 border border-brand-gray-200 rounded-lg p-3.5 mb-5 text-xs">
                  ...
                  {/* Tools Mastered */}
                  <div>
                    <div className="text-[11px] uppercase text-brand-gray-500 mb-2 font-semibold">
                      Core Tools:
                    </div>
                    <div className="flex flex-wrap gap-1.5">
                      {program.tools.slice(0, 4).map((tool) => (
                        <span
                          key={tool}
                          className="text-[11px] bg-brand-gray-100 text-brand-navy px-2 py-0.5 rounded border border-brand-gray-200 font-medium"
                        >
                          {tool}
                        </span>
                      ))}
                      {program.tools.length > 4 && (
                        <span className="text-[11px] text-brand-gray-500 px-1.5 py-0.5 font-medium">
              ...
              <div className="p-6 pt-4 border-t border-brand-gray-200 bg-brand-gray-50/50 flex items-center justify-between">
                <div>
                  <div className="text-[10px] uppercase text-brand-gray-500 font-semibold">
                    Tuition
                  </div>
        ...
        <div className="bg-brand-navy text-white rounded-2xl p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 max-w-xl">
            <div className="inline-flex items-center gap-2 text-xs uppercase tracking-wider text-brand-amber font-bold mb-2 bg-white/10 px-3 py-1 rounded-full">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Take our 60-second aptitude assessment. We will analyze your analytical vs. visual problem-solving preferences and recommend your highest-potential programme.
            </p>
          </div>
