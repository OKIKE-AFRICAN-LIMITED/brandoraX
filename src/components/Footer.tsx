...
import { Send, HelpCircle, ArrowRight, Sparkles, ChevronDown } from 'lucide-react';
    ...
    <footer className="bg-[#00081E] text-white pt-16 sm:pt-20 pb-12 px-4 sm:px-6 border-t border-white/10 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 md:gap-10 lg:gap-12 mb-12 sm:mb-16">
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 text-gray-400 md:hidden transition-transform duration-200 ${
                  openSections.programmes ? 'rotate-180 text-[#FEC958]' : 'group-hover:text-white'
                }`}
              />
            </button>
          ...
          <div className="lg:col-span-2 border-b border-white/10 md:border-b-0">
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 text-gray-400 md:hidden transition-transform duration-200 ${
                  openSections.ecosystem ? 'rotate-180 text-[#FEC958]' : 'group-hover:text-white'
                }`}
              />
            </button>
          ...
          <div className="lg:col-span-2 border-b border-white/10 md:border-b-0">
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 text-gray-400 md:hidden transition-transform duration-200 ${
                  openSections.contact ? 'rotate-180 text-[#FEC958]' : 'group-hover:text-white'
                }`}
              />
            </button>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col items-center justify-center gap-5 text-xs text-gray-400 text-center">
          ...
          <div className="hidden sm:flex flex-wrap justify-center gap-6 text-xs text-gray-400 pt-2">
            <Link to="/academy" className="hover:text-white transition-colors">
              Programmes
            </Link>
            <Link to="/community" className="hover:text-white transition-colors">
