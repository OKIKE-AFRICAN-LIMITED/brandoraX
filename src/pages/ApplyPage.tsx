...
import { CheckCircle2, ArrowRight, ArrowLeft, ShieldCheck, CreditCard, Send, Sparkles, User, Mail, Phone, Globe, Lock } from 'lucide-react';
...
export const ApplyPage: React.FC<ApplyPageProps> = ({ onEnrollSuccess }) => {
  ...
  const [selectedTrackId, setSelectedTrackId] = useState<string>(initialTrackParam || 'web-dev');
  ...
  useEffect(() => {
    if (initialTrackParam) {
      setSelectedTrackId(initialTrackParam);
    }
  }, [initialTrackParam]);
  ...
  return (
    <div className="bg-brand-gray-50 min-h-screen py-16 px-4 sm:px-6 flex items-center justify-center">
      <div className="max-w-2xl w-full bg-white border border-brand-gray-200 rounded-2xl p-6 sm:p-10 shadow-brand">
        {/* Stepper Progress Header */}
        <div className="mb-8">
          <div className="flex items-center justify-between text-xs font-mono text-brand-gray-500 mb-2 font-semibold">
            <span className="text-brand-blue uppercase font-bold">
              Step {step} of 4: {
        ...
        {step === 1 && (
          <div>
            ...
            <button
              onClick={() => setStep(2)}
              className="w-full bg-brand-blue hover:bg-brand-blue-hover text-white py-4 rounded-md font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-md"
            >
        ...
        {step === 2 && (
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => setStep(1)}
                className="px-5 py-3.5 border border-brand-gray-300 hover:bg-brand-gray-100 rounded-md text-xs font-mono uppercase text-brand-gray-600 transition-colors"
              >
                Back
              </button>
              <button
                ...
                className="flex-1 bg-brand-blue hover:bg-brand-blue-hover text-white py-3.5 rounded-md font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-md"
              >
                Continue to Tuition Plan
                <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        ...
        {step === 3 && (
          <div>
            ...
            <div className="bg-brand-gray-50 border border-brand-gray-200 rounded-xl p-4 mb-8">
              ...
              <div className="flex items-center gap-3 text-xs text-brand-gray-500 font-mono">
                <span className="bg-white px-2.5 py-1 rounded border border-brand-gray-200 font-bold text-brand-navy">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex-1 bg-brand-navy hover:bg-black text-white py-3.5 rounded-md font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-md disabled:opacity-50"
              >
                {isProcessing ? (
        ...
        {step === 4 && (
          <div className="text-center py-4">
            ...
            <div className="bg-brand-blue-surface border border-brand-blue/30 rounded-xl p-5 mb-8 text-left">
            ...
            <button
              ...
              className="w-full bg-brand-navy hover:bg-black text-white py-4 rounded-md font-bold text-xs uppercase tracking-wider transition-all shadow-md inline-flex items-center justify-center gap-2"
            >
              Go to Student Dashboard Portal
              <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        )}
